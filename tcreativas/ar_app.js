...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-frani.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('a.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('a.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('b.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('b.obj', function (group) {
                    RhinoMesh2 = group.children[0];
                    RhinoMesh2.material.side = THREE.DoubleSide;
                    RhinoMesh2.scale.set(0.05, 0.05, 0.05);
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('c.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('c.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('d.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('d.obj', function (group) {
                    RhinoMesh4 = group.children[0];
                    RhinoMesh4.material.side = THREE.DoubleSide;
                    RhinoMesh4.scale.set(0.05, 0.05, 0.05);
